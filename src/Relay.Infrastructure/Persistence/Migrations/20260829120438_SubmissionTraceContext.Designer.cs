...
namespace Relay.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260829120438_SubmissionTraceContext")]
    partial class SubmissionTraceContext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Relay.Domain.Messaging.Message", b =>
                {
                    ...
                    b.Property<string>("submission_trace_parent")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
            ...
            modelBuilder.Entity("Relay.Infrastructure.Callbacks.CallbackRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("callback_records", (string)null);
                });
